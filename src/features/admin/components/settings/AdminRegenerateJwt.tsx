...
import { useAdminRegenerateJwtMutation } from "../../hooks/useAdminRegnerateJwtMutation";

export function AdminRegenerateJwt() {
  const { mutate, isPending } = useAdminRegenerateJwtMutation();
